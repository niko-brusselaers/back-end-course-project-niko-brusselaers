...
@section('content')
    <div class="card m-3 p-3 d-flex justify-content-between align-content-center" style=" min-height: 40vh; width: 40vw" >
        ...
        <div class="d-flex w-100 justify-content-between align-item-center" style="">
            <a class="btn btn-secondary btn-lg p-2" href="{{route("admin.edit", ['userId' => $user->id])}}">edit item</a>
            <a class="btn btn-danger btn-lg p-2 " href={{route("admin.delete", ['userId' => $user->id])}}>delete item</a>
        </div>
    </div>
@endsection
